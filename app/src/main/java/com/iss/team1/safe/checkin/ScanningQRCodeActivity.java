...
import com.iss.team1.safe.checkin.camera.manager.AmbientLightManager;
import com.iss.team1.safe.checkin.camera.manager.BeepManager;
import com.iss.team1.safe.checkin.camera.manager.CameraManager;
import com.iss.team1.safe.checkin.camera.widget.ViewfinderView;
...
public class ScanningQRCodeActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void decodeImageFailed() {
        ...
        builder.setMessage("QR code not found");
    ...
    private void displayFrameworkBugMessageAndExit() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(getString(R.string.app_name));
        builder.setMessage("Unfortunately, there is a problem with the Android camera. Pls restart your device");
        builder.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
